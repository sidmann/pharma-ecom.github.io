...
/**
 * upadateProfileName(role,name)
 * @param {*} role 
 * @param {*} fullName 
 * @returns 
 */
export function updateProfileName(role, fullName) {
...
/**
 * updateProfilePicture(role,profilepic)
 * @param {*} role 
 * @param {*} profilePicture 
 * @returns 
 */
export function updateProfilePicture(role, profilePicture) {
